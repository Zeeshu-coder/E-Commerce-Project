...
const Register = () => {
        ...
        const handleSubmit=async(e)=>{
          e.preventDefault();
          try {
            await AuthService.register(fullname, email, psw, phno);
                 ...
                 <div className="new md:w-full w-full flex flex-col justify-center ">
                   ...
                   <form onSubmit={handleSubmit} className='form flex flex-col items-center md:w-110'>
                         <input type="text" placeholder='Full name'
                          ...
                          className='name w-[60%] md:w-[70%] border-2 p-3 mb-5 rounded-sm' />
                        ...
                        <input type="phone" placeholder='Phone number' 
                          ...
                          className='phone w-[60%] md:w-[70%] border-2 p-3 mb-5 rounded-sm' />
